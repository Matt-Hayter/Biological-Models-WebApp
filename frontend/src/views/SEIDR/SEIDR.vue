    ...
    <div class="rhs-page-component">
      ...
      <div class="top-section">
        <div class="title-and-formula">
          ...
          <div class="formula">
            <katex-element
              expression="\Large\dfrac{dS}{dt}=\Lambda-\mu S - \beta \dfrac{SI}{N}"
            />
            <br />
            <br />
            <katex-element
              expression="\Large\dfrac{dE}{dt}=\beta \dfrac{SI}{N} - (\mu + \epsilon)E"
            />
            <br />
            <br />
            <katex-element
              expression="\Large\dfrac{dI}{dt}=\epsilon E - (\gamma + \mu + \alpha)I"
            />
            <br />
            <br />
        ...
        <ModelInfo style="padding-left: 1.5em; padding-right: 1.5em">
          <b-card-text>
            This model is an extension of the classical SIR model of disease
            spread. Its increased complexity allows for more accurate modelling
            of real life events, such as the spread of COVID-19 within a
            population. Individuals within the population exist in, and
            transition between, one of five states:
          </b-card-text>
          <b-card-text>
            <ul>
              <li>
              ...
              <li>
                Exposed (<katex-element expression="E" />) - Indiduals that are
                infected but not yet contagious
              </li>
              <li>
                Infectious (<katex-element expression="I" />) - Indiduals that
                are infected and are contagious
              </li>
              <li>
                Dead (<katex-element expression="D" />) - Indiduals that were
                infectious and have now died from the disease
              </li>
              <li>
          ...
          <b-card-text>
            In these simulations, the total population (<katex-element
              expression="N"
            />) varies with time as the death toll rises, and is initially set
            to <katex-element expression="N=N_{0}=10" />
            million individuals.
          </b-card-text>
          <b-card-text>
            <katex-element expression="\Lambda =" /> population birth rate,
            <katex-element expression="\mu =" /> rate of natural death per
            indivdual. Here, simulations use a balanced number of births and
            natural deaths, <katex-element expression="\Lambda=\mu N" />, hence
            they are not configurable.
          </b-card-text>
          <b-card-text>
            <b>Model source</b>: J. M. Carcione at al., A Simulation of a
            COVID-19 Epidemic Based on a Deterministic SEIR Model, 2020
          </b-card-text>
        </ModelInfo>
      </div>
        ...
        //Tab one
        {
          data: [
            ...
            },
            {
              ...
              units: "(days)",
              description:
                "Average incubation period (period between exposure to disease and appearence of first sympotoms)",
      ...
      paramSuggestions: [
        {
          ...
          maths:
            "\\alpha=0.006,\\ \\beta=0.75,\\ 1/\\gamma=8,\\ 1/\\epsilon=3,\\, \
            E_{0}=20000,\\, I_{0}=1",
        },
        {
          id: 2,
          ...
          maths:
            "\\alpha=0.006,\\ \\beta=0.2,\\ 1/\\gamma=8,\\ 1/\\epsilon=3,\\, \
            E_{0}=20000,\\, I_{0}=1",
        },
        {
          id: 3,
          ...
          maths:
            "\\alpha=0.125,\\ \\beta=0.5,\\ 1/\\gamma=8,\\ 1/\\epsilon=3,\\, \
            E_{0}=20000,\\, I_{0}=1",
        },
        {
          id: 4,
  ...
  methods: {
    ...
    E0I0UpdateS0() {
      ...
      this.barPlotS0 =
        ...
        this.simParamData[E0ParamIndex] -
